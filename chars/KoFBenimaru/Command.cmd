...
[State -1, MAX Raikoken tiny spark 1]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 2
anim = 13055
bindTime = -1
sprPriority = 3
...
[State -1, MAX Raikoken tiny spark 2]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 4
anim = 13055
...
[State -1, MAX Raikoken tiny spark 3]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 8
anim = 13055
...
[State -1, MAX Raikoken tiny spark 4]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 10
anim = 13055
...
[State -1, MAX Raikoken tiny spark 5]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 14
anim = 13055
...
[State -1, MAX Raikoken tiny spark 6]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 16
anim = 13055
...
[State -1, MAX Raikoken tiny spark 7]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 20
anim = 13055
...
[State -1, MAX Raikoken tiny spark 8]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 24
anim = 13055
...
[State -1, MAX Raikoken tiny spark 9]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 26
anim = 13055
...
[State -1, MAX Raikoken tiny spark 10]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 30
anim = 13055
...
[State -1, MAX Raikoken tiny spark 11]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 32
anim = 13055
...
[State -1, MAX Raikoken tiny spark 12]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 38
anim = 13055
...
[State -1, MAX Raikoken tiny spark 13]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 40
anim = 13055
...
[State -1, MAX Raikoken tiny spark 14]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 44
anim = 13055
...
[State -1, MAX Raikoken tiny spark 15]
type = Explod
trigger1 = IsHelper(3005) && var(10) = 3 && StateNo != 1008
trigger1 = var(12) = 46
anim = 13055
...
;command = "pp" || command = "kk"
trigger1 = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2) || (ifElse(NumExplod(90000230), 1, 0) + ifElse(NumExplod(90000240), 1, 0) + ifElse(NumExplod(90000250), 1, 0) >= 2)
trigger1 = RoundState = 2 && StateType = S
trigger1 = ctrl
...
triggerAll = !AILevel
;command = "holdfwd" || command = "holdback"
trigger1 = NumExplod(90000006) || NumExplod(90000004) || NumExplod(90000009) || NumExplod(90000007) || NumExplod(90000003) || NumExplod(90000001)
;command = "pp"
trigger1 = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2)
trigger1 = RoundState = 2 && StateType = A
...
triggerAll = (NumExplod(90000002) || NumExplod(90000001) || NumExplod(90000003)) && (NumExplod(90000250))
