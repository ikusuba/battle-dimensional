...
value = 355
triggerall = Command = "ennkyoritachikyoukikku" 
triggerall = RoundState = 2
triggerall = StateType != A
trigger1 = ctrl || (StateNo = [100,101]) || (StateNo = 5120 && AnimTime = -1)
trigger2 = StateNo = 215 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 3,>= 0 && AnimElem = 4, < 0))
trigger3 = StateNo = 230 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 4,>= 0 && AnimElem = 5, < 0))
trigger4 = StateNo = 245 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 3,>= 0 && AnimElem = 4, < 0))
trigger5 = StateNo = 290 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 8,>= 0 && AnimElem = 9, < 0))
trigger6 = StateNo = 400 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 5,>= 0))
trigger7 = StateNo = 410 && (MoveContact = [1,5])
trigger8 = StateNo = 430 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 4,>= 0))
trigger9 = StateNo = 440 && ((MoveContact = [1,5]) || (!MoveContact && AnimElem = 4,>= 0 && AnimElem = 5, < 0))
...
[State -1, Rei Shiki: Hou'oukyaku]
type = ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "Rei Shiki: Hou'oukyaku"
triggerAll = RoundState = 2 && StateType != A
