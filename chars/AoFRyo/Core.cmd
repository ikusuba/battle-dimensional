...
[State -1, Retsu Ryuko Ranbu]
type = ChangeState
value = 3300
triggerAll = var(40)
triggerAll = !AILevel
triggerAll = command = "RetsuRyukoRanbu"
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = var(40)
triggerAll = !AILevel
triggerAll = command = "TenchiHaohken1"
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = var(40)
triggerAll = !AILevel
triggerAll = command = "EXHienShippukyaku2"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = var(40)
triggerAll = !AILevel
triggerAll = command = "HienShippukyaku2"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
[State -1, Hien Shippukyaku]
...
[State -1, Ko'oken]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && var(20) <= 60, 1090, 1040)
triggerAll = var(40)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,80]) && P2Dist y >= -80 && EnemyNear, vel y >= 0
triggerAll = P2StateType != A || EnemyNear, vel x < 0
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger2 = EnemyNear, StateNo = 195 && Random < (50 * (AILevel ** 2 / 64.0))
...
triggerAll = (P2BodyDist x = [15,280])
...
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]),200,50) * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = var(7) && StateNo = 1301 && var(10) != 2 && Random < (250 * (AILevel ** 2 / 64.0))
trigger4 = var(7) && StateNo = 1331 && var(10) != 2 && Random < (250 * (AILevel ** 2 / 64.0))
