...
=====<FEATURES>=====
 ...
 - All her moves
 - Gameplay mix between Darkstalkers and other Capcom games, namely CvS (unfinished)
 ...
 - 2 intros and 3 winposes
 - 3 big portraits for you to choose from
 - A.I.
...
.Reitou (EX):            F, D, DF, k
.Houtengeki:             F, DF, D, DB, B, p
.Zampa (EX):             U + p (while opponent is lying down)
...
=====<MOVE DETAILS>=====
 ...
 - Sometimes, during Ankihou, Lei-Lei will throw a dizzying object. Charging the move will make it more frequent;

 - The light version of Ankihou never throws dizzying objects, unless it was charged;
...
damage any player, Lei-Lei included;
 ...
 - Inputing the Chuukadan command while a bomb is already out will detonate it;
...
Daibakusou: Rimoukon (Dark Force)     Great Burst Rush: Seperated Wild Soul
