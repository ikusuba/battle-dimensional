...
type=ChangeState
value=4400
triggerall=!AILevel && RoundState=2 && StateType != A && var(20)<=0 && !var(11) && (stateno!=[4400,4500]) && power >= 3000 && command="modechange"
...
type=ChangeState
value=3800
triggerall=!AILevel && RoundState=2 && StateType != A && var(20)<=0 && power >= 3000&&command ="ChiNoBousou"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;======================================================================================================================================================
...
type=ChangeState
value=3700
triggerall=!AILevel && RoundState=2 && StateType != A && var(20)<=0 && power >= 3000&&command ="SanShinginoNi"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;======================================================================================================================================================
...
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && StateType != A && var(20)<=0 && power >= 3000&&command ="Homurabotogi"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;======================================================================================================================================================
...
type=ChangeState
value=3550
triggerall=!AILevel && RoundState=2 && var(11)&&(stateno!=[3550,3599])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="MAXOniHomura"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
...
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && var(11)&&(stateno!=[3500,3549])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="OniHomura"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, MAX Shiki 1201: Ya Otome]
type=ChangeState
value=3250+400*var(11)
triggerall=!AILevel && RoundState=2 && (stateno!=[3250,3299]) && (stateno!=[3650,3699]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="MAXYaOtome"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, Shiki 1201: Ya Otome]
type=ChangeState
value=3200+400*var(11)
triggerall=!AILevel && RoundState=2 && (stateno!=[3200,3249]) && (stateno!=[3600,3649])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="YaOtome"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
...
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && !var(11)&&(stateno!=[3150,3199])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="MAXSakuTsumagushi"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
...
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && !var(11)&&(stateno!=[3100,3149])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="SakuTsumagushi"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
...
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001])&& StateType != A &&var(20) <= 60 && power >= 2000&&command ="MAXYaSakazuki"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
...
value=3000
triggerAll = EnemyNear, StateNo != 3010 || EnemyNear, StateNo = 3010 && EnemyNear, MoveType != H
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="YaSakazuki"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, Kuzukaze]
type = ChangeState
value=Ifelse(command="Kuzukaze EX"&&var(20) <= 60&&power>=500,1530,1500)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="Kuzukaze")||(command="Kuzukaze EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Kuzukaze EX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, Oniyaki]
type = ChangeState
value=Ifelse(command="OniyakiEX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="Oniyaki")||(command="OniyakiEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="OniyakiEX"&&power>=500&&var(20) <= 60)
trigger4=((stateno=1210)||(stateno=1240))&&movecontact
;======================================================================================================================================================
[State -1, Tsumagushi]
type = ChangeState
value=Ifelse(command="Tsumagushi EX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=!var(11)&&!AILevel && RoundState=2 && StateType != A
triggerall=((command="Tsumagushi")||(command="Tsumagushi EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Tsumagushi EX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, Kototsuki In]
type = ChangeState
value=Ifelse(command="Kototsuki InEX"&&var(20) <= 60&&power>=500,1350,1300)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="Kototsuki In")||(command="Kototsuki InEX"&&power>=500&&var(20) <= 60))
triggerAll = numhelper(3005)=0
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Kototsuki InEX"&&power>=500&&var(20) <= 60)
trigger4=((stateno=1210)||(stateno=1240))&&movecontact
;======================================================================================================================================================
[State -1, Cross Diving]
type = ChangeState
value=Ifelse(command="AoiHanaEX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="AoiHana")||(command="AoiHanaEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="AoiHanaEX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
...
type=ChangeState
value=218
triggerall=!AILevel&& roundstate=2 && statetype != A&&command != "holddown"&&command = "holdfwd"&& command="y"
trigger1=ctrl
trigger2=var(4)
trigger3=(stateno=[200,210])&&movecontact;&&!var(55)
;---------------------------------------------------------------------------
...
trigger1=ctrl
trigger2=var(4)
trigger3=(stateno=[200,218])||(stateno=220&&anim=225)||(stateno=220&&anim=10225)||(stateno=[230,240])&&movecontact;&&!var(55)
;---------------------------------------------------------------------------
...
trigger1=ctrl
trigger2=var(4)||stateno=[100,101]
...
type=ChangeState
value=633
triggerall=!AILevel&& roundstate=2 && statetype=A&&command != "holddown"&&command = "holdback"&& command="a"
trigger1=ctrl
trigger2=var(4)&&(stateno!=[1000,1900])
...
;---------------------------------------------------------------------------
[State -1, Chi No Bosou]
type=ChangeState
value=3800
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3800,3899]) && StateType != A &&!var(20)&& power >= 3000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,Movetype = A)&&!(enemynear, hitdefattr = SCA, AT, AP)&&(enemynear,stateno!=5120)&&(enemynear,stateno!=[120,155])&&(p2bodydist x =[40,80])&&(p2bodydist y=[-90,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;---------------------------------------------------------------------------
[State -1, San Shingi no Ni]
type=ChangeState
value=3700
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3700,3799]) && StateType != A &&!var(20)&& power >= 3000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) && (enemynear,statetype != A) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[-40,60]) && (p2bodydist y = 0) &&(enemynear, statetype != C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
...
type=ChangeState
value=3400
triggerall=AILevel && RoundState=2 && (stateno!=[3400,3499]) && StateType != A &&!var(20)&& power >= 3000 && random < (450 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) && !(enemynear, hitfall)&&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[60,120]) && (p2bodydist y =[-90,5])
triggerall=(enemynear,statetype!=A) && (enemynear,statetype!=S)  
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6) && movehit && random < (150 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Max Shiki 100: Oni Homura AI]
type=ChangeState
value=3550
triggerall=var(11)&&AILevel && RoundState=2 && numenemy && Stateno!=3550 && StateType != A &&var(20) <= 60 && power >= 2000
...
;---------------------------------------------------------------------------
[State -1,Oni Homura AI]
type=ChangeState
value=3500
triggerall=var(11)&&AILevel && RoundState=2 && numenemy && Stateno!=3500 && StateType != A &&var(20) <= 60 && power >= 1000
...
trigger3=(var(7)) && movehit && random<50
;----------------------------------------------------------------------
[State -1, Max Shiki 1201: Ya Otome (Orochi)]
type=ChangeState
value=3650
triggerall=var(11)&&AILevel && numenemy && RoundState=2 && (stateno!=[3650,3699]) && StateType != A && var(20)<=0 && power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
...
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(var(6)||var(7))&& movehit && random < (250 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Shiki 1201: Ya Otome (Orochi)]
type=ChangeState
value=3600
triggerall=var(11)&&AILevel && numenemy && RoundState=2 && (stateno!=[3600,3649]) && StateType != A && var(20)<=0 && power >= 1000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])&&(p2bodydist x =[40,160])&&(p2bodydist y=[-80,5])
triggerall=(enemynear,Statetype!=A) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(var(6)||var(7))&& movehit && random < (250 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Shiki 1201: Ya Otome (Normal)]
type=ChangeState
value=3200
triggerall=!var(11)&&AILevel && numenemy && RoundState=2 && (stateno!=[3200,3249]) && StateType != A && var(20)<=0 && power >= 1000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])&&(p2bodydist x =[40,160])&&(p2bodydist y=[-80,5])
triggerall=(enemynear,Statetype!=A) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(var(6)||var(7))&& movehit && random < (250 * (AIlevel ** 2 / 64.0))
;========================================================================
[State -1, 217 Shiki: Aoi Hana]
type=ChangeState
...
trigger2=var(5)
;========================================================================
[State -1, Tsumagushi AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 100), 1430, 1400)
triggerall=!var(11)&&AILevel && RoundState=2 && StateType != A &&var(20)<=60&& random < (150 * (AIlevel ** 2 / 64.0))
...
trigger2=var(5)
;========================================================================
[State -1, 212 Shiki: Kototsuki In AI]
type = ChangeState
value=1300
...
triggerall=(prevstateno!=[1300,1330])&&(p2bodydist y =[-80,5]) &&(enemynear, statetype != A) &&(enemynear, statetype != C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
;========================================================================
[State -1, 100 Shiki: Oniyaki AI]
type = changestate
value=Ifelse((power >= 500 && random < 200), 1130, 1100)
...
trigger2=var(5)
;========================================================================
[State -1, 108 Shiki: Yami Barai AI]
type=ChangeState
